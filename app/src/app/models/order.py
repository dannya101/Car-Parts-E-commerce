...
class Order(Base):
    ...
    billing_address_id: Mapped[int] = mapped_column(Integer, ForeignKey("addresses.id"), nullable=True)
    shipping_method: Mapped[str] = mapped_column(String, nullable=True)
